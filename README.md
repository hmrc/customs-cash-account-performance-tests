...
# customs-cash-account-performance-tests
Performance test suite for the `Customs cash account`, using [performance-test-runner](https://github.com/hmrc/performance-test-runner) under the hood.
...
sm --start CUSTOMS_FINANCIALS_TESTS -r
```
